...
public:
	...
	template <class U>
	friend Mat3<U> operator-(const Mat3<U> &a);
	template <class U>
	friend Mat3<U> operator+(const Mat3<U> &a, const Mat3<U> &b);
	template <class U>
	friend Mat3<U> operator-(const Mat3<U> &a, const Mat3<U> &b);
	template <class U>
	friend Mat3<U> operator*(const Mat3<U> &a, const Mat3<U> &b);
	template <class U>
	friend Mat3<U> operator*(const Mat3<U> &a, const double d);
	template <class U>
	friend Mat3<U> operator*(const double d, const Mat3<U> &a);
	template <class U>
	friend Mat3<U> operator/(const Mat3<U> &a, const double d);
	template <class U>
	friend Vec3<U> operator*(const Mat3<U> &a, const Vec3<U> &v);
	template <class U>
	friend bool operator==(const Mat3<U> &a, const Mat3<U> &b);
	template <class U>
	friend bool operator!=(const Mat3<U> &a, const Mat3<U> &b);
...
public:
		...
		for (i = 0; i < 4; i++)
		{
			...
			for (k = 0; k < 4; k++)
			{
				if (k != i)
				{
					...
					{
						a[k][l] -= aki * a[i][l];
						if (fabs(a[k][l]) < 0.00000001)
							a[k][l] = 0.0;
						b[k][l] -= aki * b[i][l];
						if (fabs(b[k][l]) < 0.00000001)
							b[k][l] = 0.0;
					}
				}
			}
	...
	template <class U>
	friend Mat4<U> operator-(const Mat4<U> &a);
	template <class U>
	friend Mat4<U> operator+(const Mat4<U> &a, const Mat4<U> &b);
	template <class U>
	friend Mat4<U> operator-(const Mat4<U> &a, const Mat4<U> &b);
	template <class U>
	friend Mat4<U> operator*(const Mat4<U> &a, const Mat4<U> &b);
	template <class U>
	friend Mat4<U> operator*(const Mat4<U> &a, const double d);
	template <class U>
	friend Mat4<U> operator*(const double d, const Mat4<U> &a);
	template <class U>
	friend Vec3<U> operator*(const Mat4<U> &a, const Vec3<U> &b);
	template <class U>
	friend Vec4<U> operator*(const Mat4<U> &a, const Vec4<U> &b);
	template <class U>
	friend Mat4<U> operator/(const Mat4<U> &a, const double d);
	template <class U>
	friend bool operator==(const Mat4<U> &a, const Mat4<U> &b);
	template <class U>
	friend bool operator!=(const Mat4<U> &a, const Mat4<U> &b);
