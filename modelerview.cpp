...
void ModelerView::draw()
{
	...
	lightDiffuse1[0] = VAL(LIGHT1_R);
	lightDiffuse1[1] = VAL(LIGHT1_G);
	lightDiffuse1[2] = VAL(LIGHT1_B);
	...
	if (ps != NULL)
	{
		// std::cout << "particle system exists, compute and draw" << std::endl;
