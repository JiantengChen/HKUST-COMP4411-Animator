...
public:
	...
	template <class U>
	friend Vec<U> operator-(const Vec<U> &v);
	template <class U>
	friend Vec<U> operator*(const Vec<U> &a, const double d);
	template <class U>
	friend Vec<U> operator*(const double d, const Vec<U> &a);
	template <class U>
	friend Vec<U> operator/(const Vec<U> &a, const double d);
	template <class U>
	friend Vec<U> operator^(const Vec<U> &a, const Vec<U> &b);
	template <class U>
	friend bool operator==(const Vec<U> &a, const Vec<U> &b);
	template <class U>
	friend bool operator!=(const Vec<U> &a, const Vec<U> &b);
	template <class U>
	friend ostream &operator<<(ostream &os, const Vec<U> &v);
	template <class U>
	friend istream &operator>>(istream &is, Vec<U> &v);
	template <class U>
	friend Vec<U> minimum(const Vec<U> &a, const Vec<U> &b);
	template <class U>
	friend Vec<U> maximum(const Vec<U> &a, const Vec<U> &b);
	template <class U>
	friend Vec<U> prod(const Vec<U> &a, const Vec<U> &b);
...
public:
	...
	template <class U>
	friend U operator*(const Vec3<U> &a, const Vec4<U> &b);
	template <class U>
	friend U operator*(const Vec4<U> &b, const Vec3<U> &a);
	template <class U>
	friend Vec3<U> operator-(const Vec3<U> &v);
	template <class U>
	friend Vec3<U> operator*(const Vec3<U> &a, const double d);
	template <class U>
	friend Vec3<U> operator*(const double d, const Vec3<U> &a);
	template <class U>
	friend Vec3<U> operator*(const Vec3<U> &v, Mat4<U> &a);
	template <class U>
	friend U operator*(const Vec3<U> &a, const Vec3<U> &b);
	template <class U>
	friend Vec3<U> operator*(const Mat3<U> &a, const Vec3<U> &v);
	template <class U>
	friend Vec3<U> operator*(const Vec3<U> &v, const Mat3<U> &a);
	template <class U>
	friend Vec3<U> operator*(const Mat4<U> &a, const Vec3<U> &v);
	template <class U>
	friend Vec3<U> operator/(const Vec3<U> &a, const double d);
	template <class U>
	friend Vec3<U> operator^(const Vec3<U> &a, const Vec3<U> &b);
	template <class U>
	friend bool operator==(const Vec3<U> &a, const Vec3<U> &b);
	template <class U>
	friend bool operator!=(const Vec3<U> &a, const Vec3<U> &b);
	template <class U>
	friend ostream &operator<<(ostream &os, const Vec3<U> &v);
	template <class U>
	friend istream &operator>>(istream &is, Vec3<U> &v);
	template <class U>
	friend Vec3<U> minimum(const Vec3<U> &a, const Vec3<U> &b);
	template <class U>
	friend Vec3<U> maximum(const Vec3<U> &a, const Vec3<U> &b);
	template <class U>
	friend Vec3<U> prod(const Vec3<U> &a, const Vec3<U> &b);
...
public:
	...
	friend U operator*(const Vec4<U> &b, const Vec3<U> &a);
	template <class U>
	friend Vec4<U> operator-(const Vec4<U> &v);
	template <class U>
	friend Vec4<U> operator*(const Vec4<U> &a, const double d);
	template <class U>
	friend Vec4<U> operator*(const double d, const Vec4<U> &a);
	template <class U>
	friend U operator*(const Vec4<U> &a, const Vec4<U> &b);
	template <class U>
	friend Vec4<U> operator*(const Mat4<U> &a, const Vec4<U> &v);
	template <class U>
	friend Vec4<U> operator*(const Vec4<U> &v, const Mat4<U> &a);
	template <class U>
	friend Vec4<U> operator/(const Vec4<U> &a, const double d);
	template <class U>
	friend Vec4<U> operator^(const Vec4<U> &a, const Vec4<U> &b);
	template <class U>
	friend bool operator==(const Vec4<U> &a, const Vec4<U> &b);
	template <class U>
	friend bool operator!=(const Vec4<U> &a, const Vec4<U> &b);
	template <class U>
	friend ostream &operator<<(ostream &os, const Vec4<U> &v);
	template <class U>
	friend istream &operator>>(istream &is, Vec4<U> &v);
	template <class U>
	friend Vec4<U> minimum(const Vec4<U> &a, const Vec4<U> &b);
	template <class U>
	friend Vec4<U> maximum(const Vec4<U> &a, const Vec4<U> &b);
	template <class U>
	friend Vec4<U> prod(const Vec4<U> &a, const Vec4<U> &b);
